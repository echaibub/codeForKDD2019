...
outFileName <- "sim_study_H1c_H1d_weak.RData"
...
for (i in seq(nSim)) {
  ...
  dat <- GenerateData(n = my.n,
                      ...
                      p01 = p01,
                      p00 = p00,
                      alpha = c(my.beta, my.theta), ## beta (label effect), theta (conf effect)
                      rho = my.rho,
  ...
  if (i %in% saveCheckPoints) {
    cat("saving ", i, " H1 confounding, H1 disease weak simulations", "\n")
...
outFileName <- "sim_study_H1c_H1d_moderate.RData"
...
for (i in seq(nSim)) {
  ...
  if (i %in% saveCheckPoints) {
    cat("saving ", i, " H1 confounding, H1 disease moderate simulations", "\n")
    save(out, file = outFileName, compress = TRUE)
  }
}
...
outFileName <- "sim_study_H1c_H1d_strong.RData"
...
for (i in seq(nSim)) {
  ...
  if (i %in% saveCheckPoints) {
    cat("saving ", i, " H1 confounding, H1 disease strong simulations", "\n")
    save(out, file = outFileName, compress = TRUE)
  }
}
